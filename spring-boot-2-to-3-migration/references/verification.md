...
- If Maven dependency resolution fails but repository access still exists, probe visible artifact versions and retry with the first downloadable candidate before treating the repository as blocked.
